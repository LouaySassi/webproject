...
>>>>>>> Stashed changes
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Les voitures</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="car.html" class="dropdown-item">Liste des voitures</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="team.html" class="dropdown-item">Qui sommes nous ?</a>
                                <a href="testimonial.html" class="dropdown-item">Avis des utilisateurs</a>
                            </div>
                        </div>
                        <a href="contact.html" class="nav-item nav-link">Contancez-nous</a>
                        <a href="http://localhost/demo/adamindan.com/loginpage.php" class="nav-item nav-link">S'identifier</a>
                    </div>
                </div>
            </nav>
        </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-secondary p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-light text-uppercase m-0">Kesintisiz Araç Satışı</h4>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-uppercase m-0">Geniş Bayii Ağı</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Özel Araç Satışı</h4>
                        <p class="m-0"> Hem bireysel müşterilere hem de kurumsal şirketlere özel olarak araç satışı yapıyoruz. İhtiyaçlarınıza uygun aracı bulmanız için geniş bir seçenek sunuyoruz.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Kusursuz Araç Muayenesi</h4>
                        <p class="m-0">Araçlarınızın kapsamlı bir muayeneden geçirildiği ve yüksek kalite standartlarına uygun olduğunu garanti ediyoruz.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Sorunsuz Tamir Hizmetleri</h4>
                        <p class="m-0">Arızalı veya hasarlı araçlarınızı uzman ekibimizle tamir ediyor ve müşterilerinize sorunsuz bir sürüş deneyimi sunuyoruz.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Temizlik ve Hijyen Garantisi</h4>
                        <p class="m-0">Satışa sunduğumuz araçların temizlik ve hijyen açısından özenle hazırlandığına ve müşterilere temiz bir araç deneyimi sunulduğuna emin olabilirsiniz.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Size Uygun Aracı Bulalım</h1>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="img/Capture.PNG" alt="">
                        <h4 class="text-uppercase mb-4">TOGG T10X</h4>
                        ...
                        <a class="btn btn-primary px-3" href="">1.250.000 TL</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item active mb-4">
                        <img class="img-fluid mb-4" src="img/Capture1.PNG" alt="">
                        <h4 class="text-uppercase mb-4">Citroen C4 1.2 PureTech</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2022</span>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="img/skodasol.png" alt="">
                        <h4 class="text-uppercase mb-4">Škoda Kamiq</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2022</span>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <h4 class="text-uppercase mb-4"> Mercedes-Benz GLC</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <h4 class="text-uppercase mb-4">AUDİ R8</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2012</span>
 ...
 <div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
    <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <p class="mb-2"><i class="fa fa-map-marker-alt text-white mr-3"></i>Campus unviersaitaire - Manar - Tunis<br> Tunisie</p>
            <p class="mb-2"><i class="fa fa-phone-alt text-white mr-3"></i>+216 99 485 200</p>
            <p><i class="fa fa-envelope text-white mr-3"></i>nosvoitures.com
            </p>
            <h6 class="text-uppercase text-white py-2">nos réseaux sociaux</h6>
...
>>>>>>> Stashed changes
         ...
         <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column justify-content-start">
                <a class="text-body mb-2" href="http://localhost/demo/adamindan.com/contact.php"><i class="fa fa-angle-right text-white mr-2"></i></a>
                <a class="text-body mb-2" href="http://localhost/demo/adamindan.com/contact.php"><i class="fa fa-angle-right text-white mr-2"></i></a>
                <a class="text-body mb-2" href="http://localhost/demo/adamindan.com/contact.php"><i class="fa fa-angle-right text-white mr-2"></i></a>
                <a class="text-body mb-2" href="http://localhost/demo/adamindan.com/contact.php"><i class="fa fa-angle-right text-white mr-2"></i></a>
                <a class="text-body" href="http://localhost/demo/adamindan.com/contact.php"><i class="fa fa-angle-right text-white mr-2"></i></a>
            </div>
        </div>            <div class="col-lg-3 col-md-6 mb-5">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            <h4 class="text-uppercase text-light mb-4">Tenez moi informé</h4>
            <p class="mb-4">Partageons avec vous de nouvelles publications et campagnes</p>
            <div class="w-100 mb-3">
                <div class="input-group">
                    <input type="text" class="form-control bg-dark border-dark" style="padding: 25px;" placeholder="Tapez votre mail">
                    <div class="input-group-append">
                        <button class="btn btn-primary text-uppercase px-3">S'identifier</button>
                    </div>
                </div>
            </div>
            <i>Annulez quand vous voulez</i>
        </div>
    </div>
</div>
<div class="container-fluid bg-dark py-4 px-sm-3 px-md-5">
    <p class="mb-2 text-center text-body">&copy; <a href="#">nosvoitures.com</a>.Tous droits résérvés.</p>
    
    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->                 
    <p class="m-0 text-center text-body">Créé par GLSI2</a></p>
</div>
<!-- Footer End -->
